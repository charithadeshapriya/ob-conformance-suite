...
public class OpenDataSteps {
    ...
    {
        ENDPOINT_GET_BRANCHES_BY_BANK_ID =  "/v1.0.0/banks/" + Context.getInstance().getBankID() + "/branches";
    ...
    {
        ENDPOINT_GET_PRODUCTS_BY_BANK_ID =  "/v1.0.0/banks/" + Context.getInstance().getBankID() + "/products";
        httpRequest = requestGenerator.createRequest("BRANCH_END_POINT");
    }
